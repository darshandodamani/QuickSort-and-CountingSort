        ...
        for (int i = 0; i < l; i++) 
{
        ...
        int len = arr.length;
        QuickSort.QuickSortMiddle qsm = new QuickSort.QuickSortMiddle();
        qsm.QuickSortMiddleRecursion (arr,0, len-1);                          //Calling QuickSort function
        qsm.printArray (arr);
    }

    int partition (int[]arr,int l, int h)                                     /*Partition of array elements by considering mean element as reference and
